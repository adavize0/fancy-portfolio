...
intro_TL.from(displayBox, {scale: 5.4, duration: 2.4, ease: "expo.inOut"})
intro_TL.from(headingLines[0], { x: '100%', duration: 1.75, ease: introEase}, "<60%")
intro_TL.from(headingLines[1], { x: '-100%', duration: 1.75, ease: introEase }, "<")
intro_TL.from(subHeading, { autoAlpha: 0, duration: 0.9 }, '-=0.4')
intro_TL.from(chatCTA, {x: "100%", duration: 1.25, ease: introEase}, 2.1)
intro_TL.from(headerLogo, {x: "-100%", duration: 1.25, ease: introEase}, 2.1)
intro_TL.from(creditsArea, {x: "-100%", duration: 1.25, ease: introEase}, 2.1)
